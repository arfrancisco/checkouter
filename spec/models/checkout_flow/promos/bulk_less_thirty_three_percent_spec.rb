...
RSpec.describe CheckoutFlow::Promos::BulkLessThirtyThreePercent do
  ...
  describe '.apply!' do
    ...
    it 'applies a 33% discount to the order item price' do
      described_class.apply!(order_item:)
      order_item.reload

      expect(order_item.price).to eq(120) # 180 - 33% = 120
    end
  end
end
